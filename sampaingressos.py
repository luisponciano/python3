...
paginaLimite = 4 + 1 #quantidade de paginas
card_temp_min = 1
card_temp_max = 3
pag_temp_min = 2
pag_temp_max = 5
bancoDados = "C:/Users/noturno/Desktop/python2 luis.db"
saidaCSV = f"C:/Users/noturno/Desktop/SampaIngressos_Shows_{data_hoje}.csv"

for pagina in range(1,paginaLimite + 1):
    url = f"{baseURL}?page={pagina}&tipoEspetaculo=shows"
